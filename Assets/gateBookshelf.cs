...
namespace SunTemple
{
    public class gateBookshelf : MonoBehaviour
    {
        public bool IsLocked = false;
        public bool DoorClosed = true;
        public float SlideDistance = 3.0f; // Distance to move the gate to the left
        ...
        void Start()
        {
            ...
            for (int i = 0; i < gates.Count; i++)
            {
                ...
                EndPositions[i] = StartPositions[i] + new Vector3(-SlideDistance, 0, 0); // Move to the left
            }
